---
"fast-grapheme-segmenter": patch
---

Make iterator construction O(1) by arming the one-byte ASCII shortcut lazily at boundaries instead of sampling up to 64 bytes in every `Driver::new`.
